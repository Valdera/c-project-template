...
void solve() {
    ...
    // - Each team must lose 2 matches to be eliminated
    // - We have n teams, 1 winner at the end
    // - So n-1 teams are eliminated
    // - Each eliminated team loses exactly 2 matches
    // - Total losses = (n-1) * 2 = 2n - 2
    // - Each match produces exactly 1 loss
    // - Therefore, total matches = 2n - 2
